...
//    public static Map<String, Float> predict(String outputDir) throws IOException, TranslateException, ModelException {
//        Repository repository =
//                Repository.newInstance(
//                        "test",
//                        Paths.get(
...
//
//            M5Forecast testSet = getDataset(new ArrayList<>(), repository, predictionNetwork.getContextLength(), Dataset.Usage.TEST);
//
...
//
//            DeepARTimeSeries.M5Evaluator evaluator = new DeepARTimeSeries.M5Evaluator(0.5f, 0.67f, 0.95f, 0.99f);
...
//                        input.setField(FieldName.FEAT_STATIC_CAT, featStaticCatSplit.get(i).squeeze(0));
//                        batchInput.add(input);
//                    }
//                    List<Forecast> forecasts = predictor.batchPredict(batchInput);
//                    for (int i = 0; i < forecasts.size(); i++) {
//                        evaluator.aggregateMetrics(evaluator.getMetricsPerTs(gtSplit.get(i).squeeze(0), pastTargetSplit.get(i).squeeze(0), forecasts.get(i)));
//                    }
...
//    }
    ...
    private static M5Forecast getDataset(
            List<TimeSeriesTransform> transformation, Repository repository, int contextLength, Dataset.Usage usage)
            throws IOException {
        M5Forecast.Builder builder =
                M5Forecast.builder()
                        ...
                        .setSampling(16, usage == Dataset.Usage.TRAIN);
